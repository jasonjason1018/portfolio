...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/assets/styles/recipe2.css">
  </head>
  <body>
                ...
                <div class="borderFrame--outside">
                  <div class="borderFrame--inside">
                    ...
                    <ul class="practice__list">
                     ...
                     <li> <img class="hidden__phone" src="/{{ $data }}" alt=""><img class="visible__phone" src="/assets/images/recipe/recipe2-4_step1m.jpg" alt=""></li>
                    @endforeach
                    </ul>
